        ...
        <div className="service">
         <div className="container service__container">
          ...
          <li><Button name={'Другая упаковка   '}/></li>
             ...
             <ul className="service__list">
                <li className="service__item"> <img src={Service1} alt="service pic" /></li>
                <li className="service__item"> <img src={Service2} alt="service pic" /></li>
                <li className="service__item"> <img src={Service3} alt="service pic" /></li>
                <li className="service__item"> <img src={Service4} alt="service pic" /></li>
                <li className="service__item"> <img src={Service5} alt="service pic" /></li>
             </ul>
